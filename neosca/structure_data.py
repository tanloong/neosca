...
data = [
    ...
    (("C_S", "clauses per sentence"), {"requirements": ["C1", "S"]}),
    (("VP_T", "verb phrases per T-unit"), {"requirements": ["VP1", "T1", "T2"]}),
    (("C_T", "clauses per T-unit"), {"requirements": ["C1", "T1", "T2"]}),
    (("DC_C", "dependent clauses per clause"), {"requirements": ["DC", "C1"]}),
    (("DC_T", "dependent clauses per T-unit"), {"requirements": ["DC", "T1", "T2"]}),
    (("T_S", "T-units per sentence"), {"requirements": ["T1", "T2", "S"]}),
    (("CT_T", "complex T-unit ratio"), {"requirements": ["CT", "T1", "T2"]}),
    (("CP_T", "coordinate phrases per T-unit"), {"requirements": ["CP", "T1", "T2"]}),
    (("CP_C", "coordinate phrases per clause"), {"requirements": ["CP", "C1"]}),
    (
