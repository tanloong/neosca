...
```BibTeX
@misc{tan2022neosca,
title        = {NeoSCA: A Rewrite of L2 Syntactic Complexity Analyzer, version 0.0.33},
author       = {Long Tan},
...
<pre>Tan, L. (2022). <i>NeoSCA: A Rewrite of L2 Syntactic Complexity Analyzer</i> (version 0.0.33) [Software]. Github. https://github.com/tanloong/neosca</pre>
...
<pre>Tan, Long. <i>NeoSCA: A Rewrite of L2 Syntactic Complexity Analyzer</i>. version 0.0.33, GitHub, 2022, https://github.com/tanloong/neosca.</pre>
